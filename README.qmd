...
hrbrpkghelpr::stinking_badges(extra_lines = "[![R](https://github.com/hrbrmstr/hhhash/actions/workflows/r.yml/badge.svg)](https://github.com/hrbrmstr/hhhash/actions/workflows/r.yml)")
```
